...
class CollectionsArticlesWindow(QMdiSubWindow):
    ...
    def __init__(self, app: QApplication, OAuth_token: str, parent: QMainWindow, collection_id: int):
        """
    ...
    def initUI(self):
        ...
        self.article_list_widget = ArticleList(self.app, self.token, self.collection_id, self.parent)
    ...
    def on_delete_article_pressed(self):
        ...
        # If there is a selection create a dialog window to ask for deletion confirmation
            ...
            if reply == QMessageBox.Yes:
                all_errors = self.delete_multiple_articles(self.collection_id, article_ids)
